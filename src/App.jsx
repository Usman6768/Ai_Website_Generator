...
import { API_KEY } from './utils/apis.js';
...
const App = () => {
  ...
  const [code, setCode] = useState(
    `
        ...
        <body class="p-[10px]">
          <h1 class="text-[30px] font-[700]">Welcome to AI Website Generator</h1>
        </body>
        </html>
    `
  );
  ...
  const downloadCode = () => {
    let filename = "ai_generated_website.html";
  ...
  async function getResponse() {
    ...
    setLoading(true);
    const text_prompt = Prompt(prompt);
  ...
  return (
    <>
      ...
      <div className="container">
        <h3 className='text-[30px] font-[700]'>Create beautiful websites with <span className='bg-gradient-to-br from-violet-400  to-purple-600 bg-clip-text text-transparent'>AI Website Generator</span></h3>
